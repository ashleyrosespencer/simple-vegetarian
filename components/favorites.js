        ...
        {Posts.map(recipe => (
          <div key={recipe.id} className="bg-white rounded shadow p-4">
            ...
            <div className="mt-4">
              ...
              <p className="text-gray-800 mt-2">{limitDescription(recipe.description) || 'No description available.'} <a className="text-orange-500 hover:text-orange-700 mt-2" href={`/recipes/${recipe.id}`}>
                Read More {'>'}{'>'}
              </a></p>
